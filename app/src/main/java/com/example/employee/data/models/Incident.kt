...
import com.example.employee.CheckInOut
import com.example.employee.hasPermission
import com.example.employee.utilities.Constants.Companion.MINIMUM_SENIORITY_FREE_RETARDANT
import com.example.employee.utilities.Constants.Companion.NUMBER_OF_RETARDANT_EQUIVALENT_TO_ONE_ABSENCE
...
data class Incident(
    ...
    private fun getRetardant(): Int {
        val checks = checksInOut.filter {
            it.employee == employee && it.date >= initialDate && it.date <= finalDate
        }
